    ...
    return (
      <div className="min-h-screen bg-ink-900 flex items-center justify-center px-4">
        <div className="w-full max-w-md text-center">
          <div className="w-16 h-16 rounded-full bg-gold-500/20 flex items-center justify-center mx-auto mb-5">
          ...
          <Link href="/auth/login" className="btn-secondary text-sm">Back to login</Link>
        </div>
      </div>
    )
  }
      ...
      <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="hidden md:block">
          ...
          <h2 className="font-display text-3xl font-bold text-white mb-3">
            Your business,<br />
            <span className="text-gold-400">finally visible.</span>
          </h2>
          <p className="text-ink-400 mb-8 leading-relaxed">
            Join South Africa's most powerful directory for Black-owned SMEs. Free to start.
          </p>
          <ul className="space-y-3">
            {PERKS.map(perk => (
              <li key={perk} className="flex items-center gap-3 text-sm text-ink-300">
        ...
        <div>
          <div className="text-center md:text-left mb-6">
            <div className="md:hidden mb-4">
              <Link href="/" className="inline-flex items-center gap-2.5">
                ...
                <span className="font-display text-lg font-bold text-white">Black<span className="text-gold-400">Biz</span></span>
              </Link>
            </div>
            <h1 className="font-display text-2xl font-bold text-white mb-1">Create account</h1>
            <p className="text-ink-400 text-sm">Free forever. Upgrade when you're ready.</p>
          </div>
          ...
          <div className="card p-7">
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="text" className="input pl-9" placeholder="Your full name"
            ...
            <p className="text-center text-sm text-ink-500 mt-5">
              ...
              <Link href="/auth/login" className="text-gold-400 hover:underline font-medium">Sign in</Link>
            </p>
          </div>
        </div>
      </div>
